                            ...
                            <tbody> 
                                ...
                                <?php foreach ($lokasi as $val) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="" data-toggle="modal" data-target="#modalLokasi"><button type="button" name="ubah" class="btn btn-success btn-sm modalUbahLokasi" data-id="<?= $val['id_lokasi']; ?>"><i class="fa fa-pencil"></i></button></a>
                                                <a href="<?= site_url('Admin/delete_lokasi/' . $val['id_lokasi']) ?>"><button href="<?= site_url('Admin/delete_lokasi/' . $val['id_lokasi']) ?>" type="button" class="btn btn-danger btn-sm tombol-hapus"><i class="fa fa-trash"></i></button></a>
                                            </center>
                                        </td>
                                    </tr>
                                <?php } ?>
