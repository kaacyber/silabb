                            ...
                            <tbody>
                                ...
                                <?php foreach ($user as $val) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="" data-toggle="modal" data-target="#modalUser"><button type="button" name="ubah" class="btn btn-success btn-sm modalUbahUser" data-id="<?= $val['id_user']; ?>"><i class="fa fa-pencil"></i></button></a>
                                                <a href="<?= site_url('Admin/delete_user/' . $val['id_user']) ?>"><button href="<?= site_url('Admin/delete_user/' . $val['id_user']) ?>" type="button" class="btn btn-danger btn-sm tombol-hapus"><i class="fa fa-trash"></i></button></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
